...
# Various integrated options for teacher 
def teacher_session():
    while 1:
        print("")
...
# Various integrated options for student 
...
# Various integrated options for admin 
def admin_session():
    while 1:
        print("")
        print("Admin Menu")
...
# Authorized student login input
def auth_student():
    print("")
...
# Authorized teacher login input
def auth_teacher():
    print("")
...
# virtual options display prompt
def main():
    while 1:
